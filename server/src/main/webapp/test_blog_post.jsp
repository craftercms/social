<html>
	<head>
		<title>Sample BLOG POST UGC page</title>
	</head>
    <body>
		...
		<script type="text/javascript" src="resources/js/ugc_blog_post.js"></script>
		<script type="text/javascript" src="resources/js/tiny_mce_dev.js"></script>
		<link rel="stylesheet" href="resources/css/style.css" type="text/css" media="screen"/>
		<!-- <link rel="stylesheet" href="resources/css/blog-custom.css" type="text/css" media="screen"/>
