 ...
 * <li>Check that this call are made with an authenticated user and the the UGC belongs to the user's tenantId.</li>
 * </ul>
 * </p>
 */
public interface UGCService<T extends UGC> {
    ...
    /**
     * <p>Creates an UGC.</p>
     * <p>Implementers must check if the current user is allow to create UGC for that tenantId</p>
     *
     ...
     */
    void setAttributes(final String ugcId, final String tenantId, Map<String,
        Object> attributes) throws SocialException;
     ...
     * @throws java.lang.IllegalArgumentException               If given UGC does not exist.*
     */
    public void deleteAttribute(final String ugcId, final String[] name, final String tenantId) throws SocialException;
     ...
     * @throws java.lang.IllegalArgumentException               If given UGC does not exist.*
     */
    boolean deleteUgc(final String ugcId, final String tenantId) throws SocialException;
