...
public class UGCRestController {
    ...
    private static final List<String> ugcFieldList = Arrays.asList(new String[] {"parentId", "textContent",
    ...
    public List<PublicUGC> findByModerationStatusAndTargetId(@PathVariable final String moderationStatus,
        ...
        defaultValue = "DESC") String sortOrder, final HttpServletResponse response) throws IOException {
    ...
    @ModelAttribute
    public PublicUGC addUGC(@RequestBody(required = true) UGCRequest ugcRequest, HttpServletRequest request) throws
        PermissionDeniedException {
    ...
    @ModelAttribute
    public PublicUGC updateUGC(@RequestBody(required = true) UGCRequest ugcRequest,
    ...
    @ModelAttribute
    public PublicUGC addAttachments(HttpServletRequest request, @PathVariable final String ugcId,
                                    @RequestParam final String tenant, @RequestParam(required = true) MultipartFile[]
    ...
    @ModelAttribute
    public AttachmentModel addAttachments(HttpServletRequest request, @PathVariable final String ugcId,
                                          @RequestParam final String tenant, @RequestParam(required = true)
    MultipartFile attachment) throws PermissionDeniedException, AttachmentErrorException {
    ...
    @ModelAttribute
    public List<AttachmentModel> getAttachments(HttpServletRequest request, @PathVariable final String ugcId,
    ...
    @ModelAttribute
    public void deleteUGC(HttpServletRequest request, @PathVariable final String ugcId,
    ...
    @ModelAttribute
    public void deleteUGC(HttpServletRequest request, @RequestParam List<String> ugcIds,
