...
public class ThreadsController {
	...
	@ResponseBody
	public boolean changeSubscribe(@PathVariable final String id, @RequestParam(required = false, defaultValue = "") final String frequency, @RequestParam final String context) throws UGCException {
		Profile p = SocialSecurityUtils.getCurrentProfile();
		if (!p.getUsername().equals(SocialSecurityUtils.ANONYMOUS)) {
	...
	@ResponseBody
	public boolean changeSubscribePost(@PathVariable final String id, @RequestParam(required = false, defaultValue = "") final String frequency, @RequestParam final String context) throws UGCException {
