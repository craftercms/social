...
public class ThreadsController {
    ...
    @RequestParam(required = false) final List<String> sortBy, @ApiParam("Sort Order") @RequestParam(required =
        ...
        thread.setComments(ugcService.read(id, SocialSecurityUtils.getCurrentProfile().getTenant(), start, pageSize,
    ...
    @RequestParam(required = false) final List<String> sortBy, @ApiParam("Sort Order") @RequestParam(required =
        ...
        thread.setComments(ugcService.readChildren(commentId,id, SocialSecurityUtils.getCurrentProfile().getTenant(), start,
