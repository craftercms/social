    ...
    var CommentView = Base.extend({
        ...
        uploadAvatar: function(){
            ...
            modal.set({
                ...
                'body': '<div class="form-group"><input id="avatarFileupload" type="file" name="avatar" value="Choose new profile picture"><br/><p>If you choose to upload a photo please select a current business relevant photo of yourself.</p><div id="progress"><div class="bar" style="width: 0%;"></div></div>     </div>',
                //---------------  modification to add picture guidelines -----------//
